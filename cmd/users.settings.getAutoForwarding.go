...
var usersSettingsGetAutoForwarding = &cobra.Command{
	Use: "users.settings.getAutoForwarding <userId>",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		val, err := service.Users.Settings.GetAutoForwarding(args[0]).Do()
		cobra.CheckErr(err)
...
func init() {
	requestCmd.AddCommand(usersSettingsGetAutoForwarding)
}
