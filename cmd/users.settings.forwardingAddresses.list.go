...
var usersSettingsForwardingAddressesList = &cobra.Command{
	Use: "users.settings.forwardingAddresses.list <userId>",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		val, err := service.Users.Settings.ForwardingAddresses.List(args[0]).Do()
		cobra.CheckErr(err)
		fmt.Println(val)
	},
}
...
func init() {
	requestCmd.AddCommand(usersSettingsForwardingAddressesList)
}
