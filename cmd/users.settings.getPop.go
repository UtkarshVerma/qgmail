...
var usersSettingsGetPop = &cobra.Command{
	Use: "users.settings.getPop <userId>",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		val, err := service.Users.Settings.GetPop(args[0]).Do()
		cobra.CheckErr(err)
...
func init() {
	requestCmd.AddCommand(usersSettingsGetPop)
}
